...
public class ApiExplorer {
	...
	public static void main(String[] args) throws IOException {
		...
		ArrayList<ItemDTO> list = a.fromJSONtoItems(result);
	...
	public String api() throws IOException {
		...
		urlBuilder.append("?" + URLEncoder.encode("serviceKey", "UTF-8")
				+ "=d9LHQ39Jo2yMHM94lSeHU6hcA1leSEC2UW79oWDRyPpWUtKbzl1azmILwu5QUm0ynt%2BAyH%2FS3SuBgK4N7JWuFg%3D%3D"); /*
																														 * Service
																														 * Key
																														 */
	...
	public ArrayList<ItemDTO> fromJSONtoItems(String result) {
		...
		System.out.println("r" + rjson);

		JSONObject r2 = rjson.getJSONObject("response").getJSONObject("body");

		int count = r2.getInt("totalCount");
		System.out.println("count =" + count);
		
		JSONArray list = r2.getJSONArray("items");
		ArrayList<ItemDTO> dList = new ArrayList<>();
		
		for(int i = 0; i<list.length();i++) {

		JSONObject o = list.getJSONObject(i);

		String ig = o.getString("informGrade");
		String ic = o.getString("informCause");
		String io = o.getString("informOverall");
		
		ItemDTO dtoList = new ItemDTO();
		dtoList.setInformGrade(ig);
		dtoList.setInformCause(ic);
		dtoList.setInformOverall(io);
		 ...
		 * }
		 * 
		 * System.out.println("ArrayList==>" +list); return list;
		 * 
		 * 
		 */
